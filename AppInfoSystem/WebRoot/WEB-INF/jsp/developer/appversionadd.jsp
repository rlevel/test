...
<div class="x_panel">
	<div class="x_title">
		<h2>新增APP版本信息<small><i class="fa fa-user">${devUserSession.devname}</i></small></h2>
						...
						<tbody>
							<c:forEach items="${appVersionList}" var="appVersion">
								...
								<tr>
									...
									<td><fm:formatDate value="${appVersion.creationDate}"
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form id="demo-form2" data-parsley-validate
					action="${path}/appInfo/addversionsave" method="post"
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" id="versionSize" name="versionSize"
								...
								placeholder="请输入版本大小,单位为Mb" value="" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12"
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<textarea id="versionInfo" name="versionInfo" required="required"
								...
								class="control-label col-md-3 col-sm-3 col-xs-12"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12"
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="file" id="a_downloadLink" name="a_downloadLink"
								required="required" class="form-control col-md-7 col-xs-12">${fileUploadError}
						</div>
					</div>
