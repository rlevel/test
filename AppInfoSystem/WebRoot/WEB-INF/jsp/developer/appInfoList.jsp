	...
	<div class="x_panel">
		...
		<div class="x_content">
			...
			<div id="datatable_wrapper"
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable_responsive_info" role="status"
							aria-live="polite">共${pages.totalCount}条记录
						...
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
								<c:if test="${pages.currentPageNo > 1}">
									...
									aria-controls="datatable_responsive" data-dt-idx="1" tabindex="0">
									Previous</a></li>
								</c:if>
								<c:if test="${pages.currentPageNo < pages.totalPageCount}">
									<li class="paginate_button"><a
									href="javascript:page_nav(document.forms[0],${pages.currentPageNo+1});" 
									aria-controls="datatable_responsive" data-dt-idx="1" tabindex="0">Next</a></li>
								<li class="paginate_button next"><a
									href="javascript:page_nav(document.forms[0],${pages.totalPageCount});"
									 aria-controls="datatable_responsive" data-dt-idx="7" tabindex="0">尾页</a></li>
								</c:if>
